...
### 4. 다이렉트 메시지
- 웹 소켓과 Stomp를 활용하여 실시간 채팅을 구현하였습니다.
...
> "나는 고작 이런 것도 해결 못하나?"라는 생각으로 밥도 굶어가며 끝내 해결해냈었던 경험이었습니다.
...
> 이 문제도 검색으로는 해결할 수 없었던 문제여서 힘들었던 경험이었습니다.  
> 돌이켜보면 정말 단순한 문제였지만, 의도치않게 이 간단한 문제를 해결하면서  
